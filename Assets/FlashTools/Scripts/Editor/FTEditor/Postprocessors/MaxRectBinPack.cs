...
public class MaxRectsBinPack {
	...
	public List<RectInt> usedRectangles = new List<RectInt>();
	public List<RectInt> freeRectangles = new List<RectInt>();
	...
	public RectInt Insert(int width, int height, FreeRectChoiceHeuristic method) {
		RectInt newNode = new RectInt();
	...
	public bool Insert(List<RectInt> rects, RectInt[] dst, FreeRectChoiceHeuristic method)
	{
		var rectSet = new HashSet<int>();
		for (var i = 0; i < rects.Count; i++)
			rectSet.Add(i);

		while(rectSet.Count > 0) {
			int bestScore1 = int.MaxValue;
			int bestScore2 = int.MaxValue;
			int bestRectIndex = -1;
			RectInt bestNode = new RectInt();

			foreach (var i in rectSet)
			{
				int score1 = 0;
				int score2 = 0;
				RectInt newNode = ScoreRect(rects[i].width, rects[i].height, method, ref score1, ref score2);
	...
	RectInt ScoreRect(int width, int height, FreeRectChoiceHeuristic method, ref int score1, ref int score2) {
		RectInt newNode = new RectInt();
		score1 = int.MaxValue;
		score2 = int.MaxValue;
		switch(method) {
	...
	RectInt FindPositionForNewNodeBestShortSideFit(int width, int height, ref int bestShortSideFit, ref int bestLongSideFit)  {
		RectInt bestNode = new RectInt();
		//memset(&bestNode, 0, sizeof(Rect));
	...
	RectInt FindPositionForNewNodeBestLongSideFit(int width, int height, ref int bestShortSideFit, ref int bestLongSideFit) {
		RectInt bestNode = new RectInt();
		//memset(&bestNode, 0, sizeof(Rect));
	...
	RectInt FindPositionForNewNodeBestAreaFit(int width, int height, ref int bestAreaFit, ref int bestShortSideFit) {
		RectInt bestNode = new RectInt();
		//memset(&bestNode, 0, sizeof(Rect));
	...
	bool SplitFreeNode(RectInt freeNode, ref RectInt usedNode) {
	...
	bool IsContainedIn(RectInt a, RectInt b) {
